...
<br>Therefore, this library implements the functions of NAT-Gateway mentioned in RFC-6886, and it has been implemented so that it can respond correctly to the request of the NAT-PMP Client. By using this mock NAT server, you can easily test various scenarios without manipulating the actual NAT device.
